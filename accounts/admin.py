...
admin.site.site_header = "Tujjor Express"         # Appears at the top of the admin pages
admin.site.site_title = "Tujjor Express Portal"     # Appears in the browser's title bar
admin.site.index_title = "Welcome to the Tujjor Express Panel"
